...
const SignIn = () => {
    ...
    const onSubmit = async (data: SignInFormData) => {
        try {
            ...
            console.error(e);
            setApiError(e instanceof Error ? e.message : "An error occurred while signing in");
        }
    }
        ...
        <section className="relative overflow-hidden min-h-screen flex items-center justify-center">
            ...
            <div className="relative z-10 flex flex-col items-center gap-7 w-full max-w-2xl px-12 py-12 animate-fade-in">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3">
                        ...
                        <div className="pt-4">
                            <Button
                                ...
                                className="bg-zinc-50 text-zinc-900 hover:bg-zinc-200 rounded-md px-4 py-2 text-sm font-medium leading-5 cursor-pointer w-full"
                            >
                ...
                <div className="flex items-center gap-1 p-2.5">
                    ...
                    <Link
                        href="/sign-up"
                        className="text-sm font-semibold leading-5 bg-linear-to-r from-teal-600 to-cyan-600 bg-clip-text text-transparent"
                    >
                        Sign Up
                    </Link>
                </div>
